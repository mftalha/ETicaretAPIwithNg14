...
[ApiController]
// .AddJwtBearer("Admin", options => burda schema ismine admin verdiğimiz için admin diyoruz.
...
public class BasketsController : ControllerBase
{
    ...
    [HttpPost]
    [AuthorizeDefinition(Menu = AuthorizeDefinitionConstants.Baskets, ActionType = ActionType.Writing, Definition = "Add Item To Items")]
